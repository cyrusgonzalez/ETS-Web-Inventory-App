        ...
        <div class="columns ">
            <div class="column box has-text-centered">
                <asp:GridView runat="server" ID="gvitem" CssClass="table" 
                    ...
                    PagerStyle-HorizontalAlign="Center" PagerSettings-NextPageText="Next" PagerSettings-PreviousPageText="Prev" OnPageIndexChanged="gvitem_PageIndexChanged" OnSorted="gvitem_Sorted" AutoGenerateDeleteButton="true" >
                    <Columns>
            ...
            <div class="column">
                ...
                <div class="box has-text-centered">
                    <div class="columns">
                        <div class="column">
                            <asp:Label ID="Label4" runat="server">Lab Name:   </asp:Label><asp:TextBox ID="txtUpdateLab" runat="server"></asp:TextBox>
                            <asp:Label ID="Label5" runat="server">Building:   </asp:Label><asp:TextBox ID="txtUpdateBuilding" runat="server"></asp:TextBox>
                            <asp:Label ID="Label6" runat="server">Classroom:   </asp:Label><asp:TextBox ID="txtUpdateRoom" runat="server"></asp:TextBox>
